...
if( CINDER_GL_ES_2 )
	set( CINDER_OPENGL_PLATFORM "es2" )
	set( CINDER_OPENGL "-DCINDER_GL_ES_2 -s FULL_ES2=1" )
elseif( CINDER_GL_ES_3 )
	set( CINDER_OPENGL_PLATFORM "es3" )
	set( CINDER_OPENGL "-DCINDER_GL_ES_3 -s FULL_ES3=1" )
endif()

# C Flags
set( C_FLAGS "-fvisibility=default -D_UNIX ${CINDER_OPENGL} -s USE_GLFW=3 -s ALLOW_MEMORY_GROWTH=1 -s NO_EXIT_RUNTIME=1 -s DISABLE_EXCEPTION_CATCHING=0" )
set( CMAKE_C_FLAGS_DEBUG   "${C_FLAGS} -g -O0" )
set( CMAKE_C_FLAGS_RELEASE "${C_FLAGS} -Os" )

# CPP Flags
set( CXX_FLAGS "-std=c++11 -fvisibility=default -D_UNIX ${CINDER_OPENGL} -s USE_GLFW=3 -s DEMANGLE_SUPPORT=1 -s ALLOW_MEMORY_GROWTH=1 -s NO_EXIT_RUNTIME=1 -s DISABLE_EXCEPTION_CATCHING=0" )
